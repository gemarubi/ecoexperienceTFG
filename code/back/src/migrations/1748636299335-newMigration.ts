...
export class NewMigration1748636299335 implements MigrationInterface {
    name = 'NewMigration1748636299335'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`reservas\` (\`id\` int NOT NULL AUTO_INCREMENT, \`fecha\` date NOT NULL, \`hora\` varchar(255) NOT NULL, \`asistentes\` int NOT NULL, \`observaciones\` varchar(255) NULL, \`clienteId\` int NOT NULL, \`guiaId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
